...
namespace Peeper.Patches
{
    ...
    internal static class SpringManAIPatcher
    {
        ...
        {
            if (PeeperBehaviour.HasLineOfSightToPeepers(__instance.transform.position)) __instance.currentBehaviourStateIndex = 1;
        }
        [HarmonyTranspiler]
        ...
        {
            MethodInfo peeperMethod = typeof(PeeperBehaviour).GetMethod("HasLineOfSightToPeepers", BindingFlags.Public | BindingFlags.Static);
